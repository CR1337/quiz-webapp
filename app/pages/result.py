...
def render_result():
    ...
    st.subheader(Localization.get('score_announcement').format(
        score=score, max_points=max_points, predicate=Localization.get('predicates')[predicate_index], url="[www.destatis.de](https://destatis.de)")
    )
